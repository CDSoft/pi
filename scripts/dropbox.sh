...
install_dropbox()
{
    ...
    $I64 && DROPBOXINSTALL=https://www.dropbox.com/download?plat=lnx.x86_64
    $I32 && DROPBOXINSTALL=https://www.dropbox.com/download?plat=lnx.x86

    [ -n "$DROPBOXINSTALL" ] || return
